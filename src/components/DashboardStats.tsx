    ...
    <div className="grid grid-cols-1 gap-6 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 xl:grid-cols-6">
      {stats.map((stat) => {
        ...
        return (
          <div 
            key={stat.name} 
            className="group relative bg-white dark:bg-gray-800 rounded-2xl shadow-lg hover:shadow-xl transition-all duration-300 border border-gray-200 dark:border-gray-700 overflow-hidden hover:-translate-y-1"
          >
            {/* Gradient overlay */}
                    ...
                    {!stat.expiryDate ? (
                      ...
                      <div className="space-y-1">
                        <p className={`text-lg font-bold ${
                          stat.timeUntilExpiry && stat.timeUntilExpiry.days < 7 
