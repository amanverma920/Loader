...
export default function ApiLicencePage() {
  ...
  if (loading) {
    return (
      <SidebarLayout title="API Licence" description="Loading..." icon={Key} iconGradient="from-purple-500 to-indigo-600">
  ...
  return (
    <SidebarLayout
      title="API Licence"
      description="Manage your API Key and Secret Key for authentication."
      icon={Key}
