...
export default function OnlineServerPage() {
  ...
  if (loading) {
    return (
      <SidebarLayout title="Online Server" description="Loading..." icon={Server} iconGradient="from-green-500 to-emerald-600">
  ...
  return (
    <SidebarLayout
      title="Online Server"
      description="Manage server maintenance mode and status."
      icon={Server}
      iconGradient={isMaintenanceMode ? 'from-red-500 to-orange-500' : 'from-green-500 to-emerald-600'}
    >
